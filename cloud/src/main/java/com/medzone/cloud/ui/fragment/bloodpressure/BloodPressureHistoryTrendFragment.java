...
public class BloodPressureHistoryTrendFragment extends BaseFragment implements
	...
	private BPMonthlyReportFragment monthFragment;
	private BPTrendFragment recentFragment;
	...
	private void switchMonthlyReportFragment() {
		...
		if (monthFragment == null) {
			monthFragment = new BPMonthlyReportFragment();
		}
	...
	private void switchRecentlyReportFragment() {
		...
		FragmentTransaction ft = fm.beginTransaction();
		if (recentFragment == null) {
			recentFragment = new BPTrendFragment();
		}
