...
public class BloodOxygenHistoryTrendFragment extends BaseModuleFragment
	...
	private BOMonthlyReportFragment monthFragment;
	private BORecentTrendFragment recentFragment;
	...
	private void switchMonthlyReportFragment() {
		...
		if (monthFragment == null) {
			monthFragment = new BOMonthlyReportFragment();
		}
	...
	public void onClick(View v) {
		...
		case R.id.actionbar_right:
			doShare();
			break;
		case R.id.actionbar_title_left:
			switchRecentlyReportFragment();
			break;
		case R.id.actionbar_title_right:
			switchMonthlyReportFragment();
			break;
		default:
			break;
