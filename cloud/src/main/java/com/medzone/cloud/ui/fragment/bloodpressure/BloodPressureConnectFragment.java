...
public class BloodPressureConnectFragment extends BluetoothFragment implements
		OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.fragment_pressure_connect, container,
				false);
		handerIV = (ImageView) view.findViewById(id.device_oximeter_hander);
		flagIV = (ImageView) view.findViewById(id.pressure_connect_flag_iv);
		textTV = (TextView) view.findViewById(id.pressure_connect_textTV);
		successLL = (LinearLayout) view
				.findViewById(id.pressure_connect_success_ll);
		connectionLL = (LinearLayout) view
				.findViewById(id.pressure_connect_in_ll);
		startMeasureBtn = (Button) view
				.findViewById(id.pressure_connect_start_btn);
		openDeviceFL = (FrameLayout) view
				.findViewById(id.pressure_open_device_fl);
		return view;
	}
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case Constants.SLIDING_FLAG_INIT:
				new TranslateUtil(handerIV, -1.7f, 0.4f);
				break;
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case id.pressure_connect_start_btn:
		...
		case id.actionbar_right:
			...
			attachActivity.comeBackBloodPressureInput(this);
