...
public class SettingIntroduceActivity extends BaseActivity implements
		OnClickListener {
	...
	protected void initUI() {
		super.initUI();
		setContentView(R.layout.activity_setting_introduce_cloud);
	}
	...
	private void initActionBar() {
		...
		title.setText(string.actionbar_title_setting_introduce);
