...
public class BloodOxygenMonthlyPage extends CloudShareDialogPage {
	...
	public BloodOxygenMonthlyPage(Context context) {
		super(context);
	...
	public View getView() {
		...
		if (mReportEntity != null) {
			...
			tvTitle.setText("血氧月报");
			tvUnit1.setText("本月统计：");
			tvValue1.setText("本月共检测血氧" + mReportEntity.totalCounts + "次，其中异常"
	...
	public void doGetShareURL(TaskHost taskHost) {
		...
		GroupHelper.doShareUrlRecordTask(context, accessToken,
				BloodOxygenModule.TYPE, null, null, month, taskHost);
	}
