...
public class EarTemperatureRecentlyPage extends CloudShareDialogPage {
	...
	public EarTemperatureRecentlyPage(Context context) {
		super(context);
	...
	public View getView() {
		...
		if (mReportEntity != null) {
			...
			tvTitle.setText("耳温趋势");
			tvUnit1.setText("趋势统计：");
			tvValue1.setText("近" + mReportEntity.totalCounts
					+ "次检测结果中，耳温异常情况出现" + mReportEntity.abnormalCounts + "次");
	...
	public void doGetShareURL(TaskHost taskHost) {
		...
		GroupHelper.doShareUrlRecordTask(context, accessToken,
				EarTemperatureModule.TYPE, null, mReportEntity.measureUID,
				null, taskHost);
	}
