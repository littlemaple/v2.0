...
public class EarTemperatureMonthlyPage extends CloudShareDialogPage {
	...
	public EarTemperatureMonthlyPage(Context context) {
		super(context);
	...
	public View getView() {
		...
		if (mReportEntity != null) {
			...
			tvTitle.setText("耳温月报");
			tvUnit1.setText("本月统计：");
			tvValue1.setText("本月共检测耳温" + mReportEntity.totalCounts + "次，其中异常"
	...
	public void doGetShareURL(TaskHost taskHost) {
		...
		GroupHelper.doShareUrlRecordTask(context, accessToken,
				EarTemperatureModule.TYPE, null, null, month, taskHost);
	}
