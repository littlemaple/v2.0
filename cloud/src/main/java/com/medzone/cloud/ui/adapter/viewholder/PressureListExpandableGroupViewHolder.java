...
public class PressureListExpandableGroupViewHolder extends BaseViewHolder {
	...
	public PressureListExpandableGroupViewHolder(View rootView) {
		super(rootView);
	...
	public void init(View view) {
		monthTV = (TextView) view
				.findViewById(R.id.pressure_history_list_month);
		sumTimesTV = (TextView) view
				.findViewById(R.id.pressure_history_list_sum_times);
		errorTimesTV = (TextView) view
				.findViewById(R.id.pressure_history_list_error_times);
		monthStartTV = (TextView) view
				.findViewById(R.id.pressure_history_list_month_start);
		monthEndTV = (TextView) view
				.findViewById(R.id.pressure_history_list_month_end);
		image = (ImageView) view
				.findViewById(R.id.pressure_history_list_orientation);
	}
