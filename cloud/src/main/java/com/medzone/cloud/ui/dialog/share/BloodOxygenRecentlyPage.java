...
public class BloodOxygenRecentlyPage extends CloudShareDialogPage {
	...
	public void doGetShareURL(TaskHost taskHost) {
		...
		GroupHelper.doShareUrlRecordTask(context, accessToken,
				BloodOxygenModule.TYPE, null, mReportEntity.measureUID, null,
				taskHost);
	}
