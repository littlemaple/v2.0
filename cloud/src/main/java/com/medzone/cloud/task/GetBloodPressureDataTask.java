...
//
//public class GetBloodPressureDataTask extends
//		BaseGetControllerDataTask<BloodPressure> {
//
//	protected Paging<LongStepable> paging;
//	protected String uploadData;
//	protected String accessToken;
//	protected Integer eventType; // down event or up event
//	protected String deviceType = "bp";
//	protected Integer downSerial = 0;
//	protected Integer downLimit = 0;
//	protected BloodPressureController controller;
//	protected Integer otherSyncid;
//
//	public GetBloodPressureDataTask(String accessToken, String uploadData,
//			Paging<LongStepable> paging, Integer eventType, Integer downSerial,
//			Integer otherSyncid, BloodPressureController controller) {
//		super(0);
...
//						.getAccountID();
//				List<BloodPressure> retList = BloodPressure
//						.createBloodPressureList(downData, accountID);
