...
/**
 * Multiple XY series renderer. ���XYϵ����Ⱦ����
 */
public class XYMultipleSeriesRenderer extends DefaultRenderer {
	...
	/**
	 * An enum for the XY chart orientation of the X axis. һ��ö��X���XYͼ��ķ���
	 */
	public enum Orientation {
		...
		/**
		 * Return the orientation rotate angle. ���ط�����ת�Ƕȡ�
		 * 
	...
	/**
	 * Returns the current orientation of the chart X axis. ���ص�ǰ��ͼ��X�᷽��
	 * 
	...
	/**
	 * Sets the current orientation of the chart X axis. ���õ�ǰ��ͼ��X�᷽��
	 * 
	 * @param orientation
	...
	/**
	 * Returns the title for the X axis. ����X��ı��⡣
	 * 
	...
	/**
	 * Sets the title for the X axis. ����X��ı��⡣
	 * 
	 * @param title
	 *            the X axis title
	 */
	...
	/**
	 * Returns the title for the Y axis. ����Y��ı��⡣
	 * 
	...
	/**
	 * Sets the title for the Y axis. ����Y��ı��⡣
	 * 
	 * @param title
	 *            the Y axis title
	 */
	...
	/**
	 * Returns the axis title text size. ����������ı��Ĵ�С��
	 * 
	...
	/**
	 * Sets the axis title text size. ����������ı��Ĵ�С��
	 * 
	 * @param textSize
	...
	/**
	 * Returns the start value of the X axis range. ���ؿ�ʼֵX��ķ�Χ��
	 * 
	...
	/**
	 * Sets the start value of the X axis range. ���ÿ�ʼֵX��ķ�Χ��
	 * 
	 * @param min
	...
	/**
	 * Returns if the minimum X value was set. ���������СXֵ����
	 * 
	...
	/**
	 * Returns the end value of the X axis range. ���ؿ�ʼֵX��Ķ�ֵ��Χ��
	 * 
	 * @param scale
	 *            the renderer scale X�����ֵ����X�����ֵ
	 * @return the X axis range end value
	 */
	...
	/**
	 * Returns the start value of the Y axis range. ���ؿ�ʼֵY��ķ�Χ��
	 * 
	 * @param scale
	 *            the renderer scale Y�Ὺʼֵ����Y����Сֵ
	 * @return the Y axis range end value
	 */
	...
	/**
	 * Returns the end value of the Y axis range. ���ؿ�ʼֵY��Ķ�ֵ��Χ��
	 * 
	 * @param scale
	 *            the renderer scale Y�����ֵ����Y�����ֵ
	 * @return the Y axis range end value
	 */
	...
	/**
	 * Sets the approximate number of labels for the X axis. ���Ľ�������ΪX���ǩ��
	 * 
	 * @param xLabels
	...
	/**
	 * Returns the enabled state of the zoom on X axis. ���� ��X���Ƿ���Ա�����;
	 * 
	...
	/**
	 * Returns the enabled state of the zoom on Y axis. ���� ��Y�����Ƿ���Ա�����;
	 * 
	...
	/**
	 * Sets the color of the margins. ���� ��Ե����ɫ��
	 * 
	 * @param color
	 *            the margins color
	 */
	 ...
	 * [panMinimumX, panMaximumX, panMinimumY, panMaximumY] ����ƽ�Ƶ����ơ�{-10,
	 * 20, -10, 40} ��ʾ�������Ƶ�-10�������Ƶ�20�������Ƶ�-10�������Ƶ�40
	 */
	...
	/**
	 * Returns the zoom limits. ���� ���ŵ����ơ�{-10, 20, -10, 40}
	 * ��ʾ��������С��-10��������С��20��������С��-10��������С��40
	 */
	...
	/**
	 * Returns the X labels padding. ���� X���ֵ������ Padding ֵ
	 * 
	...
	/**
	 * Sets the X labels padding ���� X���ֵ������ Padding ֵ
	 * 
	 * @param padding
	...
	/**
	 * Returns the Y labels padding. ���� Y���ֵ������ Padding ֵ
	 * 
	...
	/**
	 * Sets the Y labels padding ���� Y���ֵ������ Padding ֵ
	 * 
	 * @param padding
	 *            the amount of padding between the axis and the label
	 */
