...
public class DefaultRenderer implements Serializable {
   ...
   */
	...
	/** The chart title text size. ͼ������ı��Ĵ�С�� */
	private float mChartTitleTextSize = 15;
	/** A no color constant. û����ɫ���䡣 */
	public static final int NO_COLOR = 0;
	/** The default background color. Ĭ�ϵı���ɫ��BLACK */
	public static final int BACKGROUND_COLOR = Color.BLACK;
	/** The default color for text. �ı���Ĭ����ɫ��LTGRAY */
	public static final int TEXT_COLOR = Color.LTGRAY;
	/**
	 * A text font for regular text, like the chart
	 * labels.�ı�������ı�,����ͼ���ǩ��
	 */
	private static final Typeface REGULAR_TEXT_FONT = Typeface.create(
			Typeface.SERIF, Typeface.NORMAL);
	/** The typeface name for the texts. �ı���������ơ� */
	private String mTextTypefaceName = REGULAR_TEXT_FONT.toString();
	/** The typeface style for the texts. �ı��������� */
	private int mTextTypefaceStyle = Typeface.NORMAL;
	/** The typeface for the texts �ı������� */
	private Typeface mTextTypeface;
	/** The chart background color. ͼ�?����ɫ�� */
	private int mBackgroundColor;
	/** If the background color is applied. (�Ƿ��б�����ɫ(Ӧ�ÿ�����ô�˽�))�� */
	private boolean mApplyBackgroundColor;
	/** If the axes are visible. ������Ƿ�ɼ� */
	private boolean mShowAxes = true;
	/** The axes color. ��������ɫ�� */
	private int mAxesColor = TEXT_COLOR;
	/** If the labels are visible. ��ǩ�Ƿ�ɼ� */
	private boolean mShowLabels = true;
	/** The labels color. ��ǩ����ɫ�� */
	private int mLabelsColor = TEXT_COLOR;
	/** The labels text size. ��ǩ���ı���С�� */
	private float mLabelsTextSize = 10;
	/** If the legend is visible. ���˵����ͼ�� �Ƿ�ɼ� */
	private boolean mShowLegend = true;
	/** The legend text size. ���˵����ͼ�� ����Ĵ�С */
	private float mLegendTextSize = 12;
	/** If the legend should size to fit. ���˵����ͼ�� ����Ĵ�С�Ƿ���� */
	private boolean mFitLegend = false;
	/** If the X axis grid should be displayed. X������Ƿ���Ҫ��ʾ�� */
	private boolean mShowGridX = false;
	/** If the Y axis grid should be displayed. Y������Ƿ���Ҫ��ʾ�� */
	private boolean mShowGridY = false;
	/** If the custom text grid should be displayed.�Զ����ı�����Ƿ���Ҫ��ʾ�� */
	...
	/** The antialiasing flag. �Ƿ���Ҫ ����� */
	private boolean mAntialiasing = true;
	/** The legend height. ���˵����ͼ��ĸ߶� */
	private int mLegendHeight = 0;
	/** The margins size. �����Ե�ĳߴ��С */
	private int[] mMargins = new int[] { 20, 30, 10, 20 };
	/** A value to be used for scaling the chart. (�������ű���) */
	private float mScale = 1;
	/** A flag for enabling the pan. ������Ȩ(�Ƿ����û���) */
	private boolean mPanEnabled = true;
	/** A flag for enabling the zoom. һ����־������ʹ�佹�� */
	private boolean mZoomEnabled = true;
	/**
	 * A flag for enabling the visibility of the zoom buttons. ���½ǵı佹��ť�Ŀɼ��ԡ�
	 */
	private boolean mZoomButtonsVisible = false;
	/** The zoom rate. �佹�ʡ�(Ӧ���Ƿŵ�����С�ı���) */
	private float mZoomRate = 1.5f;
	/** A flag for enabling the external zoom. ʹ�ⲿ�Ŵ�ı�־�� */
	...
	/** The selectable radius around a clickable point. һ����־������ʹԪ���ϵ���� */
	private float selectableBuffer = 15f;
	...
	/**
	 * Sets if the X axis grid should be visible. �����Ƿ���ʾ�����X�������
	 * 
	 * @param showGrid
	...
	/**
	 * Sets if the Y axis grid should be visible. �����Ƿ���ʾ�����Y�������
	 * 
	 * @param showGrid
	...
	/**
	 * Sets if the grid should be visible. �����Ƿ���ʾ�����X��Y�������
	 * 
	 * @param showGrid
	...
	/**
	 * Returns if the legend should be visible. ���� ���˵����ͼ�� �Ƿ�ɼ�
	 * 
	...
	/**
	 * Returns if the legend should size to fit. ���� ���˵����ͼ�� ����Ĵ�С�Ƿ����
	 * 
	...
	/**
	 * Returns the enabled state of the zoom. ����X���Y���Ƿ���Ա����� ������Ҳ��
	 * 
	...
	/**
	 * Returns the visible state of the zoom buttons. ���� ���½ǵı佹��ť�Ŀɼ���
	 * 
	...
	/**
	 * Sets the visible state of the zoom buttons. ���� ���½ǵı佹��ť�Ŀɼ���
	 * 
	 * @param visible
	...
	/**
	 * Returns the zoom rate. ���� �佹�ʡ�(Ӧ���Ƿŵ�����С�ı���)
	 * 
	...
	/**
	 * Returns the enabled state of the pan. ���� ������Ȩ(�Ƿ����û���)
	 * �������Ϊfalse�Ļ������޷��϶�
	 * 
	...
	/**
	 * Sets the zoom rate. ���� �佹�ʡ�(Ӧ���Ƿŵ�����С�ı���)
	 * 
	 * @param rate
	 *            the zoom rate
	 */
	 ...
	 * top, left, bottom, right ���� �����Ե�ĳߴ��С ����˳��:[�ϡ����¡���]
	 * 
