...
public abstract class AbstractChart implements Serializable {
	 ...
	 * @param calculate
	 *            if only calculating the legend size 是否计算图例说明的大小
	 * 
	...
	protected int drawLegend(Canvas canvas, DefaultRenderer renderer,
		...
		if (renderer.isShowLegend()) {
			...
			/** 比较titles.length，renderer.getSeriesRendererCount()的大小，返回值为小的那个数。 */
	...
	/**
	 * Calculates the current legend size. 计算当前图例的大小
	 * 
	 * @param renderer
	 *            the renderer
	 * @param defaultHeight
