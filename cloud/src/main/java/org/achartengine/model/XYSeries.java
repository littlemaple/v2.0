...
public class XYSeries implements Serializable {
	...
	/** Contains the annotations. ���ע�͡�������� mStringXY Ӧ����һһ��Ӧ�� */
	...
	/**
	 * Builds a new XY series. ����һ���µ� XY ϵ�м���
	 * 
	 * @param title
	 *            the series title. �����ߵ����
	 * @param scaleNumber
	 *            the series scale number ϵ�й�ģ����
	 *            �������Ϊ���ϵ�а����߷�֧(����Ĭ��Ϊ0������ ����¶���ʾͼ
	 *            (MultipleTemperatureChart)��)
	 */
	...
	/**
	 * Returns the series title. ���� ϵ�� series �ı��� (Ҳ�������½�ϵ�е����)
	 * 
	...
	/**
	 * Add an String at (x,y) coordinates ���һ���ַ�(x,y)���
	 * �����е��Ƿ����м��Vacation
	 * 
	 * @param annotation
	...
	public synchronized SortedMap<Double, Double> getRange(double start,
		...
		// 防止最右边点隐藏的时候，将第二个点当作绘画的起点导致右边一小段的直线缺失
		stop++;
